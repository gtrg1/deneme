            ...
            children: [
              ...
              SizedBox(
                ...
                child: RaisedButton(
                    ...
                    }, color:Colors.deepOrange,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
              ...
              SizedBox(
                ...
                child: RaisedButton.icon(
                  ...
                  onPressed: (){
                    showRewardedAds();
                  }, icon: Icon(Icons.ondemand_video_outlined), label: Text("Show Reward  "+"+5"), color:Colors.deepOrange,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                ),
